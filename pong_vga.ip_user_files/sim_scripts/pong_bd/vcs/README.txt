...
#
# Generated by export_simulation on Fri Oct 05 16:18:15 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './pong_bd.sh' script.

./pong_bd.sh -reset_run
...
./pong_bd.sh -noclean_files

For more information on the script, please type './pong_bd.sh -help'.
