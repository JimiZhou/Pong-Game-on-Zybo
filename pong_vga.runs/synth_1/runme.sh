...
HD_PWD='C:/Xilinx/Projects/pong_vga/pong_vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pong_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pong_bd_wrapper.tcl
