...
HD_PWD='C:/Xilinx/Projects/pong_vga/pong_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pong_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pong_bd_wrapper.tcl -notrace
